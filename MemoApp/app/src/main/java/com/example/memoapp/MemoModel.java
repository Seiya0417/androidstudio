...
public class MemoModel {
    ...
    public MemoModel(Context context){ //コンストラクト時のデータベースのファイル？
    ...
    public void start() {//リストのインスタンス化
        ...
        this.database = new MemoDatabase(context);
        database.start();
    }
    ...
    //確認
    public void getMemoResults(){
        System.out.println("mIndex: "+ mIndex);
        System.out.println("mDateResults: "+ mDateResults);
        System.out.println("mTextResults: "+ mTextResults);
    }
    ...
    public String getFocusedDate(){//mIndexが示す日時とテキストを返す
        ...
        //if(mDateResults.isEmpty() && mDateResults.get(mIndex).isEmpty()){
